...
def get_project_collection(project_id: str, app: FastAPI) -> ProjectCollection:
    ...
    if project_id not in app.state.chromadb_collections:
        app.state.chromadb_collections[project_id] = ProjectCollection(project_id, app.state)
